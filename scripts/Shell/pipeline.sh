...
# Make file specific directories
...
pandaseq -F -f ${output_dir}/02_trimmed_files/${nt_type}_${counter}/${file}_R1_val_1.fq.gz -r ${output_dir}/02_trimmed_files/${nt_type}_${counter}/${file}_R2_val_2.fq.gz -d rbfkms -u ${output_dir}/03_pandaseq_files/${nt_type}_${counter}/unmerged_pandaseq${file}.fa 2> ${output_dir}/03_pandaseq_files/${nt_type}_${counter}/${filename}pandastat.txt 1> ${output_dir}/03_pandaseq_files/${nt_type}_${counter}/merged_pandaseq_${filename}.fastq
